            ...
            public bool OnSave(bool close)
            {
                ...
                { 
                    ...
                    if (TextHelper.Exists(mirrorName))
                    {
                        ...
                        // Show a message
                        MessageBoxHelper.ShowMessage("All changes have been saved.", "Changes Saved");
                    ...
                    else
                    {
                        ...
                        MessageBoxHelper.ShowMessage("You must enter a name for this Xml Mirror file.", "Filename Required");
                    }
                }
                else
                {
                    // Show a message FileName is required.
                    MessageBoxHelper.ShowMessage("System error Xml Mirror does not exist.", "Mirror Required - System Error");
                }
