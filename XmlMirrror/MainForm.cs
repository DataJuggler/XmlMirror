...
using mirrorTypes = XmlMirror.Runtime.Enumerations;
...
namespace XmlMirror
{
    ...
    public partial class MainForm : Form, ISelectedIndexListener
    {
        ...
        private mirrorTypes.OutputTypeEnum outputType;
        ...
        #region Events
            ...
            private void BuildButton_Click(object sender, EventArgs e)
            {
                ...
                if (this.OutputType == mirrorTypes.OutputTypeEnum.Parser)
                {
                    // build the parser
                    BuildParser();
                }
                else if (this.OutputType == mirrorTypes.OutputTypeEnum.Writer)
                {
                    // Build the writer
                    BuildWriter();
                }
            ...
            private void ClearFieldLink_Click(object sender, EventArgs e)
            {
                ...
                XmlMirror.Runtime.Objects.FieldValuePair fieldValuePair = null;
            ...
            public void OnSelectedIndexChanged(DataJuggler.Win.Controls.LabelComboBoxControl control, int selectedIndex, object selectedItem)
            {
                ...
                if (TextHelper.Exists(selectedClassName))
                {
                    ...
                    if (index >= 0)
                    {
                        ...
                        string pluralClassName = PluralWordHelper.GetPluralName(className, false);
            ...
            private void XmlParserRadioButton_CheckedChanged(object sender, EventArgs e)
            {
                ...
                {
                    // Set to Parser
                    this.OutputType = mirrorTypes.OutputTypeEnum.Parser;
            ...
            private void XmlWriterRadioButton_CheckedChanged(object sender, EventArgs e)
            {
                ...
                {   
                    ...
                    this.OutputType = mirrorTypes.OutputTypeEnum.Writer;
        ...
        #region Methods
            ...
            public void AssignNode(XmlNode xmlNode, TreeNode targetNode)
            {
                ...
                XmlMirror.Runtime.Objects.FieldValuePair existingFieldValuePair = targetNode.Tag as XmlMirror.Runtime.Objects.FieldValuePair;
            ...
            public void BuildParser()
            {
                ...
                try
                {
                    ...
                    if (this.HasSelectedMirror && TextHelper.Exists(this.SelectedMirror.TargetClassName))
                    {
                        ...
                        pluralClassName = PluralWordHelper.GetPluralName(className, false);
                        ...
                        if (this.SelectedMirror.HasOutputFolderPath && this.SelectedMirror.HasFieldLinks)
                        {
                            ...
                            if (this.SelectedMirror.MirrorType == XmlMirror.Runtime.Enumerations.MirrorTypeEnum.Collection)
                            {
            ...
            private Mirror CaptureMirror()
            {
                ...
                if (this.OutputType == OutputTypeEnum.Parser)
                {
                    ...
                    if (mirror.HasCollectionNodeName)
                    {
                        ...
                        mirror.MirrorType = mirrorTypes.MirrorTypeEnum.Collection;
                    }
                    else if (HasNewObjectNodeName)
                    {
                        // if there is a CollectionNodeName
                        mirror.MirrorType = mirrorTypes.MirrorTypeEnum.Singleton;
                    }
                }
                else
                {
            ...
            /// </summary>
            private List<Runtime.Objects.FieldValuePair> ConvertFields()
            {
                // initial value
                List<Runtime.Objects.FieldValuePair> listOfFields = null;

                // if the Fields exist
                if (this.HasFields)
                {
                    // create the return value
                    listOfFields = new List<Runtime.Objects.FieldValuePair>();
                    
                    // iterate each field
                    foreach (Runtime.Objects.FieldValuePair field in this.Fields)
                    {
                        // add this field
            ...
            private string CreatePropertySetter(FieldLink fieldLink, string variableName)
            {
                ...
                if (NullHelper.Exists(fieldLink))
                {
                    ...
                    else
                    {
                        ...
                        {
                            case mirrorTypes.DataTypeEnum.Boolean:
                            ...
                            case mirrorTypes.DataTypeEnum.Integer:
                            ...
                            case mirrorTypes.DataTypeEnum.Double:
                            ...
                            case mirrorTypes.DataTypeEnum.String:
                            ...
                            case mirrorTypes.DataTypeEnum.DateTime:
                            ...
                            case mirrorTypes.DataTypeEnum.Guid:
                            ...
                            case mirrorTypes.DataTypeEnum.Enumeration:
            ...
            private void DisplayFieldLink(TreeNode rootNode, FieldLink fieldLink)
            {
                ...
                if ((rootNode != null) && (fieldLink != null))
                {
                    ...
                    foreach (TreeNode treeNode in rootNode.Nodes)
                    {
                        ...
                        fieldValuePair = treeNode.Tag as XmlMirror.Runtime.Objects.FieldValuePair;
            ...
            private void DisplayObjectFields(List<FieldValuePair> fields)
            {
                ...
                if ((ListHelper.HasOneOrMoreItems(fields)) && (this.HasSelectedClassName))
                {
                    ...
                    // iterate the fields
                    foreach (XmlMirror.Runtime.Objects.FieldValuePair field in fields)
                    {
                        // add this field
            ...
            private void DisplayXmlDoc(XmlDocument xmlDocument)
            {
                ...
                if (xmlDocument != null)
                {
                    ...
                    if (xmlDocument.HasRootNode)
                    {
                        ...
                        // set the rootXmlNode
                        XmlNode rootXmlNode = new XmlNode(xmlDocument.RootNode.NodeText, mirrorTypes.DataTypeEnum.String);
            ...
            /// </summary>
            private mirrorTypes.DataTypeEnum FindTargetDataType(string targetFieldName)
            {
                // initial value
                mirrorTypes.DataTypeEnum targetDataType = mirrorTypes.DataTypeEnum.NotSupported;
                ...
                if (TextHelper.Exists(targetFieldName))
                {
                    ...
                    {
                        // Iterate the items in the collection
                        foreach (XmlMirror.Runtime.Objects.FieldValuePair fieldValuePair in this.Fields)
                        {
            ...
            public List<FieldValuePair> GetFields(bool skipReadOnlyProperties = false)
            {
                ...
                try
                {
                    ...
                    if (isValid)
                    {
                        ...
                        {
                            // load the assembly
                            Assembly assembly = Assembly.ReflectionOnlyLoadFrom(this.SelectedAssemblyName);
                    ...
                    if ((rootNode != null) && (rootNode.Nodes != null))
                    {
                        ...
                        foreach (TreeNode treeNode in rootNode.Nodes)
                        {
                            ...
                            else if ((xmlNode != null) && (xmlNode.HasSourceFieldName) && (xmlNode.HasTargetFieldName))
                            {
                                ...
                                mirrorTypes.DataTypeEnum fieldDataType = FindTargetDataType(xmlNode.TargetFieldName);
            ...
            private void SortFields()
            {
                ...
                {
                    // convert the 
                    List<XmlMirror.Runtime.Objects.FieldValuePair> listOfFields = ConvertFields();
                    ...
                    if (fields != null)
                    {
                        ...
                        // iterate the fields
                        foreach (Runtime.Objects.FieldValuePair field in fields)
                        {
                            // add this field
                    ...
                    foreach (FieldValuePair field in this.Fields)
                    {
                        ...
                        if (!field.Skip)
                        {
                            ...
                            if (field.FieldDataType == DataTypeEnum.GenericList)
                            {
                                ...
                                string pluralFieldName = PluralWordHelper.GetPluralName(field.FieldName, false);
            ...
            private void WriteLoadListMethod(ObjectLoaderWriter writer, string className, string pluralClassName)
            {
                ...
                if ((writer != null) && (TextHelper.Exists(className, pluralClassName)))
                {
                    ...
                    variableName = PluralWordHelper.GetPluralName(className, true);
        ...
        #region Properties
            ...
            /// </summary>
            public mirrorTypes.OutputTypeEnum OutputType
            {
