                ...
                if ((mirror != null) && (xmlNode != null))
                {
                    ...
                    switch(fullName)
                    {
                        ...
                        case "Mirror.MirrorType":
                            ...
                            mirror.MirrorType = EnumHelper.GetEnumValue<MirrorTypeEnum>(xmlNode.FormattedNodeValue, MirrorTypeEnum.Unknown);
                        ...
                        case "Mirror.OutputType":
                            ...
                            // Set the value for mirror.OutputFolderPath
                            mirror.OutputType = EnumHelper.GetEnumValue<OutputTypeEnum>(xmlNode.FormattedNodeValue, OutputTypeEnum.Unknown);
